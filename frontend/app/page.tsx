...
function MetricIcon({ name, tone = "blue" }: { name: AppIconName; tone?: IconTone }) {
    return (
            ...
            <aside className="sidebar">
                ...
                {NAV_ITEMS.map((item, i) => (
                    <button
                        key={item.label}
                        type="button"
                        className={i === 0 && currentView === "dashboard" ? "nav-item active" : "nav-item"}
                        onClick={() => {
                            if (item.label === "Dashboard") setCurrentView("dashboard");
                            if (item.label === "Import Job") openImportDrawer();
                        }}
                    >
                    ...
                    <div className="panel-title">
                        <div>
                            <h2>
                                ...
                                Application Tracker
                                <span className="info-icon" aria-label="Application tracker information">
